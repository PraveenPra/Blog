<x-master-layout>
    <div class="container mx-auto p-4">
        ...
        <p>Welcome to my personal portfolio blog! My name is Manikanta, and I am passionate about web development, software engineering, game  development and more.</p>
        <h2 class="text-xl font-bold mt-4">My Journey</h2>
        <p>I started my journey in web development in 2019, and since then, I have been dedicated to honing my skills and expanding my knowledge. This blog serves as a platform to showcase my projects, share my experiences, and connect with like-minded individuals.</p>
