<div class="card bg-transparent shadow-md rounded-lg mb-3">
    ...
    <div class="content relative dark:bg-gray-800">
        <p class="head dark:bg-gray-800">
            <br>
            <span class="p-4 font-medium font-sans dark:text-gray-300">
                {{ $post->category->name }}</span>
        </p>
        <div class="p-4">
            <h2 class="text-xl font-semibold dark:text-gray-300">{{$post->title}}</h2>
