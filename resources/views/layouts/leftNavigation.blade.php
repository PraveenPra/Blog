    ...
    <div :class="{'block': open, 'hidden': ! open}" class="block sm:block">
        ...
        <div class="flex flex-col items-center">
            ...
            <div class="flex flex-col items-end gap-4">
                ...
                @can('view categories')
                <div class="shrink-0 flex items-center border-b-2 border-gray-50  p-4 sm:p-6 lg:p-8">
                    <a href="{{ route('categories.index') }}" class="shrink-0 flex items-center gap-2 {{request()->routeIs('categories.index')? 'border-r-4 border-gray-500' : ''}}">
                ...
                <div class="shrink-0 flex items-center   p-4 sm:p-6 lg:p-8">
